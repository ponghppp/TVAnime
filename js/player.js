...
(function(){
	...
	Player.setupEventListeners = function () {
		...
		// triggered when video metadata was loaded, i.e. duration dimensions
		// etc
		...
		// triggered when the browser is in the process of getting the media
		// data
        this.videoElem.addEventListener('progress', function () {
        	console.log("Buffering...");
        }, false);

        // triggered when a file is ready to start playing (when it has buffered
		// enough to begin)
